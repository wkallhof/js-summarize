...
jSSummarize.prototype = {
     ...
     */
    summarize: function (title, text, options) {
    ...
    /**
     * Reads in the user provided options object and maps
     * the properties
     ...
     */
    sentencePosition: function (index, numberOfSentences) {
